...
#41 real Firebase Auth + locked Firestore rules — **including player-level accounts (required by #59)** · #40 XSS escaping · #42 CI test gate · #58 deploy allowlist · #50 automated backup · #57 dependency pinning
